...
from imagenet_model import BiasLayer
from resnet import PreResNet
...
class Trainer:
    def __init__(self, train_data, val_data, test_data, total_cls):
        ...
        self.model = PreResNet(224,total_cls).cuda()
        print(self.model)
        ...
        self.bias_layers=[self.bias_layer1, self.bias_layer2, self.bias_layer3, self.bias_layer4, self.bias_layer5, self.bias_layer6, self.bias_layer7, self.bias_layer8, self.bias_layer9, self.bias_layer10]
    ...
    def bias_forward(self, input):
        ...
        out8 = self.bias_layer8(in8)
        out9 = self.bias_layer9(in9)
        out10 = self.bias_layer10(in10)
